...
<body>
    <header class="header">
        <div class="container header-container">
            <div class="logo">
                <h1><a href="inicioPaciente.php">CliniGest</a></h1>
            </div>
            ...
            <nav class="nav-menu">
                <ul>
                    <li class="active">
                        <a href="inicioPaciente.php" class="nav-link">Inicio</a>
                    </li>
                    <li>
                        <a href="inicioPaciente.php#servicios" class="nav-link">Servicios</a>
                    </li>
                    <li>
                        <a href="inicioPaciente.php#departamentos" class="nav-link">Departamentos</a>
                    </li>
                </ul>
            </nav>
            ...
            <div class="header-actions">
                ...
                <div class="user-menu">
                    ...
                    <div class="user-dropdown">
                        <ul>
                            <li><a href="perfilPaciente.php"><i class="fas fa-user"></i> Mi Perfil</a></li>
                            <li><a href="misCitas.php"><i class="fas fa-calendar-check"></i> Mis Citas</a></li>
                            <li><a href="valoraciones.php"><i class="fas fa-cog"></i> Valoraciones</a></li>
                            <li class="divider"></li>
